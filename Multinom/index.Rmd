...
shinyApp(
  ...
  server = function(input, output) {
    ...
    plot_data=eventReactive(input$FaixaEtaria,{
      ...
      sd1=ajuste()$Cts[i*6,i*6,156]**0.5
      sd2=ajuste()$Cts[j*6,j*6,156]**0.5
      correl=ajuste()$Cts[i*6,j*6,156]/(sd1*sd2)
      
      tile_data[i,j]=correl
      
      cov_mat=ajuste()$Cts[c(i,j)*6,c(i,j)*6,156]
      transf=chol(cov_mat)
      ...
      for(k in c(1:n_points)){
        data[,k]=data[,k]+ajuste()$mts[c(i,j)*6,156]
      }
