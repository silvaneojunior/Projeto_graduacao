...
```{r, echo=FALSE}
valor.estimado=exp(resultado$mts[(2*4*2+1):(2*4*2+4),156])
lin_var=diag(valor.estimado)
std=sqrt(diag(lin_var%*%resultado$Cts[(2*4*2+1):(2*4*2+4),(2*4*2+1):(2*4*2+4),156]%*%lin_var))
...
```{r, echo=FALSE}
valor.estimado=exp(resultado$mts[(5*4+1):(6*4),156])
lin_var=diag(valor.estimado)
std=sqrt(diag(lin_var%*%resultado$Cts[(5*4+1):(6*4),(5*4+1):(6*4),156]%*%lin_var))
